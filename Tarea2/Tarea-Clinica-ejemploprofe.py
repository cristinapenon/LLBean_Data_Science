...
class Clinica(dict):
    ...
    def agregar_paciente(self,identificación,
        ...
        #accesos a la clase y los metodos que heredo del diccionario le llego a traves de self
        #ahorita tiene todos los de diccionario porque heredo los de esa clase y ahora agrega una definicion de agregar_paciente
        #self es la coneccion al objeto clase


        print('Paciente agregado',repr(self[identificación]))

    # repr
    # representacion de ese objeto, como el objeto se pinta en pantalla
    ...
    #le va a dar una lista de listas donde cada elemento es una lista de enferemedades de cada persona
    #el creo una funcion que se llama flatten que es una funcion al principio de la clase. esta funcion es para aplanar listas de listas.
    #despues para quitar duplicados nada mas lo hace set
...
# los ** permite agregar en desorden porque sin eso cree que le esta dando 1 solo parametro
#los ** permite meter todos los parametros de una vez.
